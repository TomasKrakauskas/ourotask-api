...
exports.getOne = async (id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!id) return reject(new Error('No id specified'))
            ...
            Checklist.findById(mongoose.Types.ObjectId(id)).exec((e, _item) => {
...
exports.getAll = async (task_id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!task_id) return reject(new Error('No id specified'))
            ...
            Checklist.find({ task_id: mongoose.Types.ObjectId(task_id)})
            .exec((e, _item) => {
                if(e) return reject(e);
                else if(_item) return resolve(_item);
                else return reject(new Error('Invalid id'))
...
exports.update = async (id, task_type, title) => {
    return new Promise(async function (resolve, reject) {
        if(!id) return reject(new Error('no id specified'))
        else Checklist.findByIdAndUpdate( mongoose.Types.ObjectId(id), {
...
exports.deleteOne = async (id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!id) return reject(new Error('No id specified'))
            ...
            Checklist.findByIdAndDelete(mongoose.Types.ObjectId(id), {}, (e, _item) => {
                if(e) return reject(e);
                else if(_item) {
                    return resolve(_item);
                }
...
exports.deleteMany = async (task_id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!task_id) return reject(new Error('No id specified'))
            ...
            Checklist.deleteMany({ task_id: mongoose.Types.ObjectId(task_id) }, {}, 
            (e, _item) => {
                if(e) return reject(e);
                else if(_item) return resolve(_item);
                else return reject(new Error('Invalid id'))
