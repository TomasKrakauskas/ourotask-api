    ...
    return new Promise(async function (resolve, reject) {
        ...
        if(!creator) return reject(new Error('No creator specified'))
            ...
            const board = new Board({
                creator_id: mongoose.Types.ObjectId(creator),
                user_group_id: null,
...
exports.getOne = async (id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!id) return reject(new Error('No id specified'))
            ...
            Board.findById(mongoose.Types.ObjectId(id)).exec((e, _item) => {
...
exports.getAll = async (creator) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!creator) return reject(new Error('No id specified'))
            ...
            Board.find({ creator_id: mongoose.Types.ObjectId(creator)})
            .exec((e, _item) => {
                if(e) return reject(e);
                else if(_item) return resolve(_item);
                else return reject(new Error('Invalid id'))
...
exports.getAllFavorite = async (creator) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!creator) return reject(new Error('No id specified'))
            ...
            Board.find({ creator_id: mongoose.Types.ObjectId(creator), favorite: true })
            .exec((e, _item) => {
                if(e) return reject(e);
                else if(_item) return resolve(_item);
                else return reject(new Error('Invalid id'))
...
exports.getAllNonFavorite = async (creator) => {
    return new Promise(async function (resolve, reject) {

        if(!creator) return reject(new Error('No id specified'))
        else 
            Board.find({ creator_id: mongoose.Types.ObjectId(creator), favorite: false })
            .exec((e, _item) => {
                if(e) return reject(e);
                else if(_item) return resolve(_item);
                else return reject(new Error('Invalid id'))
...
exports.update = async (id, title, description, favorite) => {
    return new Promise(async function (resolve, reject) {
        if(!id) return reject(new Error('no id specified'))
        else Board.findByIdAndUpdate( mongoose.Types.ObjectId(id), {
            title: title ? title: '',
            description: description ? description : '',
...
exports.incrementCounter = async (id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!id) return reject(new Error('no id specified'));
            ...
            Board.findByIdAndUpdate(mongoose.Types.ObjectId(id), {
...
exports.deleteOne = async (id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!id) return reject(new Error('No id specified'))
            ...
            Board.findByIdAndDelete(mongoose.Types.ObjectId(id), {}, async (e, _item) => {
                if(e) return reject(e);
                else if(_item) {
                    try {
                        await Promise.all([
...
exports.deleteMany = async (creator) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!creator) return reject(new Error('No id specified'))
            ...
            Board.deleteMany({ creator_id: mongoose.Types.ObjectId(creator) }, {}, 
            async (e, _item) => {
                if(e) return reject(e);
                else if(_item) {
                    try {
