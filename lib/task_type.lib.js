...
exports.getOne = async (id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!id) return reject(new Error('No id specified'))
            ...
            Label.Task_type(mongoose.Types.ObjectId(id)).exec((e, _item) => {
...
exports.getAll = async (board_id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!board_id) return reject(new Error('No id specified'))
            ...
            Label.find({ board_id: mongoose.Types.ObjectId(board_id)})
            .exec((e, _item) => {
                if(e) return reject(e);
                else if(_item) return resolve(_item);
                else return reject(new Error('Invalid id'))
...
exports.update = async (id, icon, title, color) => {
    return new Promise(async function (resolve, reject) {
        if(!id) return reject(new Error('no id specified'))
        else Label.findByIdAndUpdate( mongoose.Types.ObjectId(id), {
            icon: icon ? icon : '',
            title: title ? title : '',
            color: color ? color : '',
        }, {}, (e, _item) => {
...
exports.deleteOne = async (id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!id) return reject(new Error('No id specified'))
            ...
            Task_type.findByIdAndDelete(mongoose.Types.ObjectId(id), {}, (e, _item) => {
                if(e) return reject(e);
                else if(_item) {
...
exports.deleteMany = async (board_id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!board_id) return reject(new Error('No id specified'))
            ...
            Task_type.deleteMany({ board_id: mongoose.Types.ObjectId(board_id) }, {}, 
            (e, _item) => {
                if(e) return reject(e);
                else if(_item) return resolve(_item);
                else return reject(new Error('Invalid id'))
