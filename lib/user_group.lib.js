...
exports.getOne = async (id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!id) return reject(new Error('No id specified'))
            ...
            User_group.findById(mongoose.Schema.Types.ObjectId(id)).exec((e, _item) => {
...
exports.getAll = async (creator_id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!creator_id) return reject(new Error('No creator id specified'))
            ...
            User_group.find({ creator_id: mongoose.Schema.Types.ObjectId(creator_id)})
            .exec((e, _item) => {
                if(e) return reject(e);
                else if(_item) return resolve(_item);
                else return reject(new Error('Invalid id'))
...
exports.update = async (id, title) => {
    return new Promise(async function (resolve, reject) {
        if(!id) return reject(new Error('no id specified'))
        else User_group.findByIdAndUpdate( mongoose.Schema.Types.ObjectId(id), {
            title: title ? title: '',
        }, {}, (e, _item) => {
            if(e) return reject(e);
...
exports.addUser = async (id, user_id) => {
    return new Promise(async function (resolve, reject) {
        if(!id) return reject(new Error('no id specified'))
            ...
            $push: {
                users: mongoose.Schema.Types.ObjectId(user_id)
            }
        }, {}, (e, _item) => {
            if(e) return reject(e);
            else if(_item) return resolve({ user_group_id: _item._id });
...
exports.deleteOne = async (id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!id) return reject(new Error('No id specified'))
            ...
            User_group.findByIdAndDelete(mongoose.Schema.Types.ObjectId(id), {}, (e, _item) => {
                if(e) return reject(e);
                else if(_item) { 
                    //remove assignee's
                    return resolve(_item); 
...
exports.deleteMany = async (board_id) => {
    return new Promise(async function (resolve, reject) {
        ...
        if(!board_id) return reject(new Error('No id specified'))
            ...
            User_group.deleteMany({ board_id: mongoose.Schema.Types.ObjectId(board_id) }, {}, 
            (e, _item) => {
                if(e) return reject(e);
                else if(_item) {
                    //remove assignee's
